...
FuncDcl = tipo:(Tipos/"void") _ id:Identificador _ "(" _ params:Parametros? _ ")" _ bloque: Bloque {return crearNodo('dclFunc', {id, params: params || [] , bloque, tipo})}
...
Foreach = "for" _ "(" _ tipo: Tipos _ id: Identificador _ ":" _ id2: Identificador _ ")" _ stmt: Stmt {return crearNodo('foreach', {tipo, id, id2, stmt})}
