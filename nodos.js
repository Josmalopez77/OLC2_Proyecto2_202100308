...
export default { Expresion, OperacionBinaria, OperacionUnaria, Agrupacion, Primitivo, DeclaracionVariable, ReferenciaVariable, Print, ExpresionStmt, Asignacion, Bloque, If, While, For, Foreach,Switch, Break, Continue, Return, Llamada, FuncDcl, Param, ClassDcl, Instancia, Get, Set }